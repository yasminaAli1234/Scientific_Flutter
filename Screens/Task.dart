        ...
        children: [
           Padding(
            ...
            child: Row(
              ...
              children: [
                const Text("Assignment", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black),),
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Settingss()));
                  },
  ...
  void _handleSearch(String input) {
    ...
    setState(() {
      _results = tasks.where((task) {
        ...
        final assignmentLowe= task.assignee.toLowerCase();
        final searchLower = input.toLowerCase();

        return titleLower.contains(searchLower) ||
            descriptionLower.contains(searchLower)||assignmentLowe.contains(searchLower);
      }).toList();
    });
  }
}
